...
| Feb 6 (M) | [A Reconfigurable Fabric for Accelerating Large-Scale Datacenter Services](http://dl.acm.org/citation.cfm?id=2665678)| Hardware acceleration | -- Submit project deliverables document (<=1 page) </br> [Supplemental reading](https://www.csl.cornell.edu/~delimitrou/papers/2021.asplos.dagger.pdf)| Tanay Asija | Xiangning Lin | Cynthia Fan |
| Feb 8 (W) | **Conference: No Classes** |  | |
| Feb 13 (M) | [A hardware accelerator for protocol buffers](https://sagark.org/assets/pubs/protoacc-micro2021-preprint.pdf) | Hardware acceleration | - [Supplemental reading 1](https://www.gwern.net/docs/cs/2021-ranganathan.pdf) </br> [Supplemental reading 2](https://michaeltaylor.org/papers/ASIC_Cloud_ISCA_2016_Proceedings.pdf) | Priyadarshini Kulkarni  | Yuxi Liu | Ziwei Wang |
| Feb 15 (W) | [AsmDB: Understanding and Mitigating Front-End Stalls in Warehouse-Scale Computers](https://dl.acm.org/doi/pdf/10.1145/3307650.3322234) | Compiler/PGO | - [Supplemental reading](https://web.eecs.umich.edu/~takh/papers/khan-twig-micro-2021.pdf) | Amos Chen |	Zihao Yang |	Christine Fang |
...
| Feb 22 (W) | [The Demikernel Datapath OS Architecture for Microsecond-scale Datacenter Systems](https://irenezhang.net/papers/demikernel-sosp21.pdf) | OS | - Guest: [Pedro Penna](https://br.linkedin.com/in/pedrohenriquepenna/en) (Microsoft) <br/> - [Supplemental reading](https://www.usenix.org/system/files/conference/osdi14/osdi14-paper-belay.pdf) | Melissa Pan | Hao Yuan | Tanay Asija |
...
| Mar 1 (W) | [Resource Central: Understanding and Predicting Workloads for Improved Resource Management in Large Cloud Platforms](https://www.microsoft.com/en-us/research/wp-content/uploads/2017/10/Resource-Central-SOSP17.pdf) | Resource management/scheduling | - Guest: [Esha Choukse](https://www.microsoft.com/en-us/research/people/eschouks/) (Microsoft Research) </br> - [Supplemental reading](http://research.google.com/pubs/pub43438.html) | Ningyuan Lu | Zihao Yang  | Yuxi Liu |
| Mar 6 (M) | **Spring break: No Classes** |  | |
| Mar 8 (W) | **Spring break: No Classes** |  | |
| Mar 13 (M) | [Sinan: ML-Based and QoS-Aware Resource Management for Cloud Microservices](https://www.csl.cornell.edu/~delimitrou/papers/2021.asplos.sinan.pdf)| Resource management/scheduling | [Supplemental reading](http://people.ece.cornell.edu/martinez/doc/asplos19.pdf) | Mujing Wang | Priyadarshini Kulkarni | Tongxuan Gao |
| Mar 15 (W) | [Serverless in the Wild: Characterizing and Optimizing the Serverless Workload at a Large Cloud Provider](https://www.microsoft.com/en-us/research/uploads/prod/2020/05/serverless-ATC20.pdf) | Serverless computing | -Guest: [Mohammad Shahrad](https://mshahrad.github.io/) (UBC) <br/> - [Supplemental reading](https://www.cs.utexas.edu/~zjia/nightcore-asplos21.pdf) | Haoying Zhang  | Christine Fang | Amos Chen  |
| Mar 20 (M) | [Cost-Efﬁcient Overclocking in Immersion-Cooled Datacenters](https://www.microsoft.com/en-us/research/publication/cost-ef%ef%ac%81cient-overclocking-in-immersion-cooled-datacenters/) | DC cooling | Guest: [Íñigo Goiri](https://www.microsoft.com/en-us/research/people/inigog/publications/) (Microsoft Research) | Ziwei Wang | Tongxuan Gao  | Priyadarshini Kulkarni |
...
| Mar 27 (M) | [Network Requirements for Resource Disaggregation](https://www.usenix.org/system/files/conference/osdi16/osdi16-gao.pdf) | Resource disaggregation | - [Supplemental reading](https://www.usenix.org/system/files/osdi18-shan.pdf) </br> - Second project milestone due (<10 pages) | Hao Yuan | Tanay Asija | Mujing Wang  |
